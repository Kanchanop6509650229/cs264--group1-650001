 ...
 * 6509650229
 * 25/10/2566
 * AddSubject สำหรับเก็บข้อมูลวิชาที่ทำการเพิ่ม
*/

package th.ac.tu.cs.Website.model;

public class AddSubject implements SubjectData{
    ...
    public AddSubject(String subjectCode, String subjectName, String subjectSection, String subjectDate, Integer subjectCredit, String subjectTeacher, String subjectTeacherCheck) {
